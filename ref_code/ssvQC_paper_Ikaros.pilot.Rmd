...
out_dir = "figs_raw_pdf_pilot"
dir.create(out_dir, showWarnings = FALSE)
res_file = function(f){file.path(out_dir, f)}
```

```{r peak files}
peak_config_dt = as.data.table(read.table("../ssvQC_peak_config.pilot.csv", sep = ",", header = TRUE, stringsAsFactors = FALSE))
...
```{r bam files}
bam_config_dt = as.data.table(read.table("../ssvQC_bam_config.pilot.csv", sep = ",", header = TRUE, stringsAsFactors = FALSE))
